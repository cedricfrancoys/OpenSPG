...
class UserRepository extends \Doctrine\ORM\EntityRepository
{
     ...
     *
     * @var \NodeBundle\Entity\Node The node object by which we will filter the Managers
     *
     ...
     *
     * @var \NodeBundle\Entity\Node The node object by which we will filter the list
