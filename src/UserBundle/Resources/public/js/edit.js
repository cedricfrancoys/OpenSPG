jQuery(document).ready(function() {
    $('[type=password]')
    	.after('<button class="btn-default btn" type="button" data-action="toggle_passwd">'+Translator.trans('Toggle password', {}, 'user')+'</button>')
    	.after('<button class="btn-default btn" type="button" data-action="generate_passwd">'+Translator.trans('Generate password', {}, 'user')+'</button>');
